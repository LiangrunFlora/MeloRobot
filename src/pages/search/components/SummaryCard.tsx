    ...
    <>
      ...
      >
        <Grid container >
          ...
          <Grid xs={3}>
            <Typography sx={{ fontFamily: 'Arial', color: 'black', fontSize:"25px" }}>MeloRobot搜索</Typography>
          </Grid>
        </Grid>
        <Card sx={{ width: "80%", marginBottom: 2, paddingTop:2}}>
          <CardContent>
            <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
              <img src={QuickAns} alt="QuickAns" style={{ maxWidth: "30px", maxHeight: "30px" }} />
        ...
        <Card sx={{ width: "80%", marginBottom: 2 }}>
          <CardContent>
            <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
              <img src={Summary} alt="QuickAns" style={{ maxWidth: "30px", maxHeight: "30px" }} />
              <Typography variant="h5" component="div">
                专业搜索
              </Typography>
            </Box>
